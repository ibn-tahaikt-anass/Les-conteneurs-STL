...
bool recherche(set<int> s1, int n) { return s1.count(n); }

bool recherche(set<int> s1, set<int>::iterator debut, set<int>::iterator fin, int n){
...
int main()
{
	...
	cout<< endl;
	cout<< endl;
	cout << "Remarque : 1 indique que le nombre exixte dans le set et 0 none existe "<<endl ;
